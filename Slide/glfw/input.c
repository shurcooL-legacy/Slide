...
// Dmitri: Set callback function for touch buttons
GLFWAPI void GLFWAPIENTRY glfwSetTouchButtonCallback( GLFWtouchbuttonfun cbfun )
{
    if( !_glfwInitialized || !_glfwWin.opened )
    {
        return;
    ...
    // Set callback function
    _glfwWin.touchButtonCallback = cbfun;
}


// Dmitri: Set callback function for touch moves
GLFWAPI void GLFWAPIENTRY glfwSetTouchPosCallback( GLFWtouchposfun cbfun )
{
    if( !_glfwInitialized || !_glfwWin.opened )
    {
        return;
    ...
    // Set callback function
    _glfwWin.touchPosCallback = cbfun;
}
