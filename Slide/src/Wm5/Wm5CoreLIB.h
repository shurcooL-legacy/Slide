...
#if _MSC_VER < 1500
#error MSVC 9.0 or later is required
#else
...
// Macros for memory management.
    ...
    //#define WM5_USE_MEMORY
        ...
        // Enable an assertion when a pre-main allocation occurs or when a
        // post-main deallocation occurs.
        #define WM5_USE_MEMORY_ASSERT_ON_PREMAIN_POSTMAIN_OPERATIONS
