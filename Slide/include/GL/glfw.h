...
typedef void (GLFWCALL * GLFWtouchbuttonfun)(int,int);		// Dmitri: Touch
typedef void (GLFWCALL * GLFWtouchposfun)(int,int,int);		// Dmitri: Touch
...
#ifdef _GLFW_DMITRI_WINDOWS_TOUCH_ENABLED
GLFWAPI void GLFWAPIENTRY glfwSetTouchButtonCallback( GLFWtouchbuttonfun cbfun );		// Dmitri: Touch
GLFWAPI void GLFWAPIENTRY glfwSetTouchPosCallback( GLFWtouchposfun cbfun );				// Dmitri: Touch
#endif // _GLFW_DMITRI_WINDOWS_TOUCH_ENABLED
