...
public:
   ...
   */
  //----------------------------------------------------------------------
  bool	Collide(SphereCache& cache, const Sphere& sphere, const Model& model, const Matrix4x4* worlds=0, const Matrix4x4* worldm=0);
...
protected:
  ...
  // Init methods
  bool		InitQuery(SphereCache& cache, const Sphere& sphere, const Matrix4x4* worlds=0, const Matrix4x4* worldm=0);
};
...
public:
  ...
  bool	Collide(SphereCache& cache, const Sphere& sphere, const HybridModel& model, const Matrix4x4* worlds=0, const Matrix4x4* worldm=0);
