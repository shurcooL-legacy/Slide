...
public:
   ...
   */
  //----------------------------------------------------------------------
  bool	Collide(OBBCache& cache, const OBB& box, const Model& model, const Matrix4x4* worldb=0, const Matrix4x4* worldm=0);

  // Settings

  //----------------------------------------------------------------------
  /**
   *	Settings: select between full box-box tests or "SAT-lite"
   ...
   *	all the settings and callbacks have been defined for a collider.
...
protected:
  ...
  // Init methods
  bool InitQuery(OBBCache& cache, const OBB& box, const Matrix4x4* worldb=0, const Matrix4x4* worldm=0);
};
...
public:
  ...
  bool		Collide(OBBCache& cache, const OBB& box, const HybridModel& model, const Matrix4x4* worldb=0, const Matrix4x4* worldm=0);
protected:
