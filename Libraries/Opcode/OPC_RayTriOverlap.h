 ...
 *	Original code from Tomas Moller's "Fast Minimum Storage Ray-Triangle
 *      Intersection".
 *	It's been optimized a bit with integer code, and modified to return
 *      a non-intersection if distance from ray origin to triangle is negative.
 *
                                        ...
                                        const Point& vert2)
{
  ...
  if(mCulling)
	...
	return false;
      ...
      // Intersection point is valid if distance is positive (else it can just
      // be a face behind the orig point)
