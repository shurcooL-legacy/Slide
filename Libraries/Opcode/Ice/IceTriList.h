...
public:
  ...
  udword    GetNbTriangles() const { return GetNbEntries()/9; }
  Triangle* GetTriangles()   const { return (Triangle*)GetEntries(); }
...
public:
  ...
  udword           GetNbTriangles() const { return GetNbEntries()/3; }
  IndexedTriangle* GetTriangles()   const { return (IndexedTriangle*)GetEntries(); }
