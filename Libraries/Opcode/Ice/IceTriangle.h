...
public:
  ...
  Triangle() {}
  //! Constructor
  Triangle(const Point& p0, const Point& p1, const Point& p2) { mVerts[0]=p0; mVerts[1]=p1; mVerts[2]=p2; }
  //! Copy constructor
  ...
  Plane		PlaneEquation() const { return Plane(mVerts[0], mVerts[1], mVerts[2]);	}
  ...
  void		ComputePoint(float u, float v, Point& pt, udword* nearvtx=0) const;
