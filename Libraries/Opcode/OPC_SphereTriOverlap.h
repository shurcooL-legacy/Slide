// This is collision detection. If you do another distance test for
// collision *response*, if might be useful to simply *skip* the test
// below completely, and report a collision.
// - if sphere-triangle overlap, result is ok
// - if they don't, we'll discard them during collision response with
//   a similar test anyway
